...
const Selection = () => {
  ...
  return (
    <div className="flex h-screen bg-[#0A0A0A] text-white overflow-hidden font-sans">
      ...
      <div className="flex-[0.6] min-w-0 relative flex flex-col border-r border-gray-900 bg-black overflow-hidden">
        {/* Header */}
        <div className="absolute top-0 left-0 right-0 p-6 flex items-center justify-between z-20 bg-gradient-to-b from-black to-transparent">
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 hover:text-[#33cf33] font-black uppercase text-xs"
          >
              ...
              <>
                <div className="absolute top-50 left-10 z-20 flex flex-col gap-3">
                  ...
                  <button
                    ...
                    className="p-3 bg-[#33cf33] rounded-full shadow-lg shadow-green-900/40"
                  >
                    <HiRefresh size={20} />
                  </button>
                </div>
                    ...
                    {zones.map((zone, index) => {
                      ...
                      return (
                        <div
                          ...
                          className={`absolute flex flex-col items-center border-4 rounded-2xl p-4 transition-all
                            ${isActive ? "bg-[#33cf33]/20 border-white scale-105 z-10 shadow-2xl" : "bg-gray-900/60 border-gray-800"}`}
                          style={style}
                        >
                          ...
                          {zone.has_seat_map && zoneSeats ? (
                                      ...
                                      {seats.map((seat) => {
                                        ...
                                        return (
                                          <button
                                            ...
                                            disabled={isOccupied}
                                            onClick={(e) => {
                                              e.stopPropagation(); // Tránh kích hoạt setActiveZone của cha
                                            ...
                                            ${
                                              isOccupied
                                                ...
                                                : isSelected
                                                  ? "bg-green-500 text-black border border-white"
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center border-2 border-dashed border-gray-700 rounded-xl w-full">
                              <span className="text-[10px] text-gray-500 font-black italic">
                                KHU VỰC ĐỨNG
                              </span>
                              <span className="text-[9px] text-gray-600 uppercase mt-1">
                                Sử dụng nút +/- ở giỏ hàng
                              </span>
                            </div>
                          )}
                        </div>
      ...
      <div className="flex-[0.4] min-w-[420px] max-w-[500px] bg-[#0F0F0F] flex flex-col border-l border-gray-900 shrink-0">
        {/* 1. Header: Thông tin sự kiện */}
        <div className="p-8 border-b border-gray-900/50 bg-gradient-to-b from-black/50 to-transparent">
          <h1 className="text-2xl font-black uppercase tracking-tighter mb-2 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">
            {concert?.concert?.title || concert?.title || "Tên sự kiện"}
          </h1>
          <div className="flex items-center gap-2 text-gray-500 font-bold text-xs">
            <span className="px-2 py-0.5 bg-white/5 rounded border border-white/10 text-[#FFD700]">
              LIVE
            </span>
              ...
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  <p className="text-[#FFD700] font-black text-sm">
                    {seat.price} <span className="text-[8px]">ETH</span>
                  </p>
                  <button
                    onClick={() =>
                      handleSeatClick(seat, { zone_id: seat.zone_id })
                    }
                    className="mt-2 text-[9px] font-black text-gray-500 uppercase opacity-0 group-hover:opacity-100 transition-opacity"
                  >
                    Xóa
                  </button>
                </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-3 bg-black rounded-lg p-1.5 border border-gray-800">
                      ...
                      <button
                        ...
                        className="w-7 h-7 flex items-center justify-center bg-[#33cf33] hover:bg-green-700 rounded-md text-xs transition-colors"
                      >
                        <HiPlus />
                      </button>
                    </div>
        ...
        <div className="p-8 bg-black border-t border-gray-900 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
          <div className="flex justify-between items-end mb-6">
            <div>
              ...
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-sm font-black text-[#FFD700]">ETH</span>
              </div>
            </div>
            <div className="text-right">
          ...
          <button
            ...
            className={`group relative w-full py-5 rounded-xl font-black uppercase text-sm tracking-widest transition-all overflow-hidden
              ${
                calculateTotal() > 0
                  ? "bg-[#33cf33] text-white shadow-2xl shadow-green-900/40 hover:bg-green-700 active:scale-[0.98]"
